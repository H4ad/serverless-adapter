...
- CORS support without rely on original framework with ([CorsFramework](./frameworks/cors))
  - Use this framework to provide a way to handle CORS in frameworks like `trpc`.
