...
You can change the HTTP Method and Path that will be used to create the request by sending `sqsForwardMethod` and `sqsForwardPath` inside [SQSAdapter](/docs/api/Adapters/AWS/SQSAdapter).
