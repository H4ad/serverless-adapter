...
You can change the HTTP Method and Path that will be used to create the request by sending `dynamoDBForwardMethod` and `dynamoDBForwardPath` inside [DynamoDBAdapter](/docs/api/Adapters/AWS/DynamoDBAdapter).
